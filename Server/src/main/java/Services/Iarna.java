...
public class Iarna extends iarnaGrpc.iarnaImplBase{
    @Override
    public void trimiteZodia(ServiceIarna.Data request, StreamObserver<ServiceIarna.Zodie> responseObserver) throws FileNotFoundException {
        ListaZodii zod=new ListaZodii(new File("src/main/resources/iarna.txt"));
